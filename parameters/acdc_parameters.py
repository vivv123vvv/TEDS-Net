...
class ACDC_dataset:
    ...
    def datapath(self, value):
        self.processed_data_path = value
...
class Parameters:
    ...
    acdc_manifest_summary: Dict = field(default_factory=dict)
    acdc_split_counts: Dict = field(default_factory=dict)

    @property
    def data_path(self):
        return self.dataset.processed_data_path

    @data_path.setter
    def data_path(self, value):
        self.dataset.processed_data_path = value
